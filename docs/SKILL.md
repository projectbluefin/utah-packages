...
| Vendor Rust crates for a Rust package whose build fails on missing system crate RPMs (Fedora 44+) | [`.agents/skills/fish-cargo-vendor/SKILL.md`](../.agents/skills/fish-cargo-vendor/SKILL.md) |
