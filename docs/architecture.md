...
because it consumes mozjs140; evolution-data-server and flatpak are late
stage-3 consumers, and gnome-shell and xdg-desktop-portal sit in stage 4
because each build-requires one of them and a lane cannot see its own
