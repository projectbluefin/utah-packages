...
class PackageInventoryTests(unittest.TestCase):
    def test_inventory_reports_every_recipe_fully_source_locked(self):
        ...
        # 191: gcc was dropped from the rebuild set (projectbluefin/utah-packages#69) and
        # firefox was dropped (projectbluefin/utah-packages#112, shipped via the flatpak).
