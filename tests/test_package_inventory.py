...
class PackageInventoryTests(unittest.TestCase):
    def test_inventory_reports_every_recipe_fully_source_locked(self):
        ...
        # 191: gcc was dropped from the rebuild set (projectbluefin/utah-packages#69)
        # and firefox after it (projectbluefin/utah-packages#113); Hummingbird
        # supplies the identical gcc-16.2.1, and firefox ships as a Flatpak, so
        # neither is built here. RecipeSetAgreementTests below is what catches a
        # removal that only reaches some of the places the set is recorded in.
