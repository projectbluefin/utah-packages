...
# Utah: the GUI is off. It is the only consumer of Qt here, Utah's desktop
# contract does not ask for wpa_gui, and Hummingbird's build root carries no
# qt-devel to build it with. NetworkManager is the front end on this image.
%bcond_with gui
