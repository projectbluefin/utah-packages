# Parity recipe (utah-packages#149): one Fedora source package (libgda) yields
# both libgda and libgda-sqlite (%package sqlite). Needed by the maintained
# Copyous extension Bluefin added (bluefin#1210). Runtime deps (glib, libxml2,
# libxslt, sqlite) are all in Hummingbird; only the recipe was missing.
%global apiver  6.0
