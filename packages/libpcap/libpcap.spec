# Parity recipe (utah-packages#149): ppp Requires libpcap, in neither Hummingbird
# nor the factory. Stage 0 so ppp (stage 1) can link it.
Name:     libpcap
Epoch:    14
Version:  1.10.6
Release:  3%{?dist}
...
%changelog
* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 14:1.10.6-3
