...
# Lockstep constraint: alsa-utils and alsa-lib release in lockstep and the utils
# need the matching libasound API. Hummingbird provides alsa-lib (currently 1.2.16.1),
# which satisfies >= %{baseversion} (1.2.16).
