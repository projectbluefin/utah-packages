# ABRT off: mdadm's only unresolved dependency was libreport-filesystem,
# for a crash-reporter event hook. Building the whole of libreport to own
# one directory in an image that ships no crash reporter is the wrong
# trade, and upstream already has the switch.
%bcond abrt 0
