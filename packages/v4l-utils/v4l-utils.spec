# Qt off: the qv4l2 and qvidcap viewers build-require Qt6, and the build
# root cannot resolve it -- Hummingbird's qt6-qtbase needs libicuuc.so.78
# while the same repository still offers libicu-77, so every provider is
# rejected. This image needs libv4l2 for gstreamer1-plugins-good, not the
# viewers.
%bcond qt 0
